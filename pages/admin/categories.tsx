...
const categories = ({cats}) => {
    ...
    const deleteCategory = async(e) => {
     ...
     const response = await axios.delete(`/api/admin/categories?cat${e.currentTarget.name}`)
                ...
                >
                  ...
                  <td>
                    ...
                    <div className="hidden group-hover:flex group-hover:w-20 group-hover:items-center group-hover:text-gray-500 group-hover:gap-x-2">
                      ...
                      <button name={cat._id} onClick={(e)=>{deleteCategory(e)}} className="p-2 hover:rounded-md hover:bg-gray-200">
